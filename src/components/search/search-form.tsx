...
const SearchForm: React.FC = () => {
    ...
    return (
        <form className="max-w-md mx-auto" onSubmit={doSearch} >
            ...
            { (!searchExecuted && status === 'loading') && <div className="text-center mt-2 text-sm text-gray-500 dark:text-gray-400">Buscando ...</div> }
            ...
            {  
                (searchResult.Total > 0 || (jobList && jobList.lengh > 0)) && 
                <>                
